...
class ApiGoogleMap:
    ...
    def __init__(self):
        ...
        self.delete_resourse = '/maps/api/place/delete/json'
    ...
    def create_new_location(self):
        ...
        result = requests.post(post_url, json=json_put_location)
        return result
    ...
    def delete_location(self, place_id):
        delete_url = self.base_url + self.delete_resourse + self.key
        print(delete_url)
        body = {
            "place_id": place_id
        }
        result = requests.delete(delete_url, json = body)
        return result